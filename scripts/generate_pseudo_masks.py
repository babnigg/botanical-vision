...
dataset (botanical-vision-256-masks) that notebook 07 trains from.
...
Training code: [`notebooks/07_train_segmentation.ipynb`](https://github.com/babnigg/botanical-vision/blob/main/notebooks/07_train_segmentation.ipynb).
"""
